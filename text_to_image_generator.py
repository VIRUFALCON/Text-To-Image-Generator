...
with st.sidebar:
    ...
    st.write("Created by Virendra Choudhary")

st.title('Text to Image Generator')  # Title of the webpage

API_URL1 = "https://api-inference.huggingface.co/models/CompVis/stable-diffusion-v1-4"  # API calling
API_URL2 = "https://api-inference.huggingface.co/models/CompVis/stable-diffusion-v1-4" #API calling
